<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="chat.aspx.cs" Inherits="ODCMSS.chat" %>
            ...
            <asp:Panel ID="Panel2" runat="server">
                <div>
                    <h5 class="alert alert-success" style="text-align: center">
                        <span> <%=Server.HtmlEncode(CurrentSender.Text).ToUpper()%></span>
                        <asp:Button ID="Logout" runat="server" Text="logout" OnClick="logout_Click" CssClass="btn btn-primary" Height="30px" st />
                    </h5>
                </div>
            </asp:Panel>
                ...
                <ContentTemplate>
                    ...
                    <div>
                        <table style="width: 120%">
                            <tr>
                                <td>
                                    <asp:TextBox ID="MSGTextBox" runat="server" placeholder="Enter message" CssClass="form-control" Width="98%"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:Button ID="sendBTN" runat="server" Text="Send" OnClick="sendBTN_Click" CssClass="btn btn-primary" Width="30%" OnClientClick="loadingIconVisible()" />
                                </td>
                            </tr>
                        </table>
